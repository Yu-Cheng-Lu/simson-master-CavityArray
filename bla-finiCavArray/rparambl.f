...
c
      ...
      real fp1,fpds1,fpds2,fpds3,fpds6
      ...
      real amptab(nxp)
      integer fpds4,fpds5
      real, dimension(1:50) :: fpds7
      real, dimension(1:50) :: fpds8
c
...
c
	 ...
	 read(10,*) fpds6
	 call comment(10)
	 read(10,*) (fpds7(i), i=1, fpds4)
	 call comment(10)
	 read(10,*) (fpds8(j), i=1, fpds5)

         if (my_node.eq.0) then
            write(ios,*) '   amp   ',fpdds1
            write(ios,*) '   depth     ',fpds1
            write(ios,*) '   length    ',fpds2
            write(ios,*) '   width    ',fpds3
            write(ios,*) '   x1num    ',fpds4
	    write(ios,*) '   x3num    ',fpds5
            write(ios,*) '   tscale     ',fpds6  
	    write(ios,*) '   x1center     ',fpds7
	    write(ios,*) '   x3center     ',fpds8        
         end if
      end if	
c
